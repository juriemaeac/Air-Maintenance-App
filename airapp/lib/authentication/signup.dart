...
import 'package:airapp/authentication/signupInstructors.dart';
                ...
                Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.transparent, //AppColors.blueAccent,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Birthdate: ${textBirthdateController.text}"),
                        Text("Account ID: $accountID"),
                        Text("School Year: $schoolYear"),
                        Text("Department: $department"),
                        Text("School Section: $schoolSection"),
                      ],
                    ),
                  ),
                  Container(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Text.rich(
                          TextSpan(
                            ...
                            children: <InlineSpan>[
                              TextSpan(
                                  text: 'Personal information controller ',
                                  style: AppTextStyles.subHeadings
                                      .copyWith(fontStyle: FontStyle.italic)),
                              TextSpan(
                                  text:
                        ...
                        Text.rich(
                          TextSpan(
                            ...
                            children: <InlineSpan>[
                              TextSpan(
                                  text: 'Personal information processor ',
                                  style: AppTextStyles.subHeadings
                                      .copyWith(fontStyle: FontStyle.italic)),
                              TextSpan(
                                  text:
                            ...
                            children: <InlineSpan>[
                              TextSpan(
                                  ...
                                  style: AppTextStyles.subHeadings
                                      .copyWith(fontStyle: FontStyle.italic)),
                              TextSpan(
                                  text: 'refers to personal information:',
                                  style: AppTextStyles.subHeadings),
                            ],
                          ),
                          textAlign: TextAlign.justify,
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: <InlineSpan>[
                        TextSpan(
                            text: 'Extraterritorial Application. – ',
                            style: AppTextStyles.subHeadings
                                .copyWith(fontStyle: FontStyle.italic)),
                        TextSpan(
                          text:
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: <InlineSpan>[
                        TextSpan(
                            text: 'General Data Privacy Principles. – ',
                            style: AppTextStyles.subHeadings
                                .copyWith(fontStyle: FontStyle.italic)),
                        TextSpan(
                          text:
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: <InlineSpan>[
                        TextSpan(
                            text: 'Subcontract of Personal Information. – ',
                            style: AppTextStyles.subHeadings
                                .copyWith(fontStyle: FontStyle.italic)),
                        TextSpan(
                          text:
                      ...
                      children: <InlineSpan>[
                        TextSpan(
                            ...
                            style: AppTextStyles.subHeadings
                                .copyWith(fontStyle: FontStyle.italic)),
                        TextSpan(
                          text: 'The data subject is entitled to:',
                          style: AppTextStyles.subHeadings,
                        ),
                      ],
                    ),
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: <InlineSpan>[
                        TextSpan(
                            text: 'Responsibility of Heads of Agencies. – ',
                            style: AppTextStyles.subHeadings
                                .copyWith(fontStyle: FontStyle.italic)),
                        TextSpan(
                          text:
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: <InlineSpan>[
                        TextSpan(
                            text: 'Applicability to Government Contractors. – ',
                            style: AppTextStyles.subHeadings
                                .copyWith(fontStyle: FontStyle.italic)),
                        TextSpan(
                          text:
